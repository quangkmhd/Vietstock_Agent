...
* **Library Architecture & Design:** `vnstocks.com_docs_vnstock-data_kien-truc-thu-vien.md`
...
* **Market Layer:** `vnstocks.com_docs_vnstock-data_market-layer-v3.md`
...
* **Reference Layer:** `vnstocks.com_docs_vnstock-data_reference-layer-v3.md`
...
* **Fundamental Layer:** `vnstocks.com_docs_vnstock-data_fundamental-layer-v3.md`
...
* **Analytics Layer:** `vnstocks.com_docs_vnstock-data_analytics-layer-v3.md`
  * *Use when:* Performing market-wide valuation analyses, tracking broad historical index P/E and P/B ratios.
* **Macro Layer:** `vnstocks.com_docs_vnstock-data_macro-layer-v3.md`
...
* **Insights Layer:** `vnstocks.com_docs_vnstock-data_insights-layer-v3.md`
...
* **V2 API Domains:**
  ...
  * Financial API: `07-financial-api.md`, `vnstocks.com_docs_vnstock_bao-cao-tai-chinh.md`
  * Fund / Screener API: `08-fund-api.md`, `09-screener-api.md`, `vnstocks.com_docs_vnstock_bo-loc-co-phieu-vnstock.md`
  * Macro Data: `vnstocks.com_docs_vnstock_du-lieu-quy-mo.md`, `vnstocks.com_docs_vnstock_du-lieu-thi-truong-hang-hoa.md`

---

## 3. Quantitative Analysis & Trading (Vnstock TA)
* **Introduction & Overview:** `vnstocks.com_docs_vnstock-ta_gioi-thieu.md`
* **Usage Steps & Indicators:** `vnstocks.com_docs_vnstock-ta_cac-buoc-su-dung.md`
...
* **DNSE Trading API:** `vnstocks.com_docs_vnstock_api-dat-lenh-giao-dich-dnse.md`
...
* **General Usage:** `vnstocks.com_docs_vnstock-news_gioi-thieu.md`, `vnstocks.com_docs_vnstock-news_huong-dan-co-ban.md`
* **Advanced Usage & Implementation:** `vnstocks.com_docs_vnstock-news_tuy-bien-nang-cao.md`, `vnstocks.com_docs_vnstock-news_mau-chuong-trinh-cap-nhat-tin-tuc.md`, `vnstocks.com_docs_vnstock-news_vi-du-thuc-te.md`
...
* **Overview & Storage:** `vnstocks.com_docs_vnstock-pipeline_gioi-thieu.md`, `vnstocks.com_docs_vnstock-pipeline_luu-tru-du-lieu-toi-uu.md`
* **Realtime Data (WebSocket):** `vnstocks.com_docs_vnstock-pipeline_ket-noi-du-lieu-realtime.md`
* **Advanced Automation:** `vnstocks.com_docs_vnstock-pipeline_tuy-chinh-pipeline.md`, `vnstocks.com_docs_vnstock-pipeline_mau-nhiem-vu-tai-du-lieu-thong-dung.md`, `vnstocks.com_docs_vnstock-pipeline_hieu-nang-toi-uu.md`
...
* **Data Visualization (ezchart):** `vnstocks.com_docs_vnstock_bieu-dien-du-lieu.md`
  * *Use when:* Using `vnstock_ezchart` to render timeseries, heatmaps, boxplots, and wordclouds.
* **Google Gemini AI Integration:** `vnstocks.com_docs_vnstock_google-gemini-ai-flash-phan-tich-du-lieu-vnstock.md`
  * *Use when:* Using the `gemini_ai` wrapper to automate data analysis and chart interpretations.
* **Messaging Bots (Telegram/Slack/Lark):** `vnstocks.com_docs_vnstock_gui-tin-nhan-telegram-slack-larksuite.md`
  * *Use when:* Setting up API webhooks for automated system alerts or daily stock reports.
* **Cloud & Proxy Utilities:** `vnstocks.com_docs_vnstock_huong-dan-vnstock-proxy-manager.md`, `vnstocks.com_docs_vnstock_luu-tru-vnstock-vao-google-drive-google-colab.md`
  * *Use when:* Bypassing rate-limiting via ProxyManager or configuring Google Colab with persistent Google Drive storage.

---

## 8. Ecosystem & Sponsor
* **Sponsor Tiers & Access:** `vnstocks.com_docs_vnstock-insider-api_index.md`
* **Version History & Changes:** `vnstocks.com_docs_vnstock-insider-api_lich-su-phien-ban.md` (and `vnstocks.com_docs_tai-lieu_lich-su-phien-ban.md`)
