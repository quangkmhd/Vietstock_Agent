---
title: 12 - Migration Guide - Hướng dẫn Nâng cấp & Di chuyển
tags:
- vnstock
- documentation
aliases:
...
4. (Đối với vnstock_data v3.0.0+) Nếu có thể, khuyến nghị bạn dần cập nhật sang Unified UI (Xem [[14-unified-ui]]). Unified UI sẽ tối ưu về mặt hiệu năng gọi dữ liệu từ xa và cung cấp lớp thông tin bổ trợ mạnh mẽ hơn nhiều lần so với các module gốc cũ.
